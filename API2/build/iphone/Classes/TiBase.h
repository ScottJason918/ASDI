...
// in simulator we redefine to format for API2 Developer console
...
{\
	NSString * exceptionName = [@"org.api2." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.api2";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIAPI2NativeItemNone = -1, 
	UIAPI2NativeItemSpinner = -2,
	UIAPI2NativeItemProgressBar = -3,
	
	UIAPI2NativeItemSlider = -4,
	UIAPI2NativeItemSwitch = -5,
	UIAPI2NativeItemMultiButton = -6,
	UIAPI2NativeItemSegmented = -7,
	
	UIAPI2NativeItemTextView = -8,
	UIAPI2NativeItemTextField = -9,
	UIAPI2NativeItemSearchBar = -10,
	
	UIAPI2NativeItemPicker = -11,
	UIAPI2NativeItemDatePicker = -12,
	
	UIAPI2NativeItemInfoLight = -13,
	UIAPI2NativeItemInfoDark = -14,
	
	UIAPI2NativeItemDisclosure = -15,
	
	UIAPI2NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all API2 instances of
