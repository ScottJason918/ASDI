...
/**
 The base class for all API2 modules
 */
...
/**
 API2 Platform calls this method on startup.
 */
-(void)startup;

/**
 API2 Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 API2 Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 API2 Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 API2 Platform calls this method on resume.
 @param sender The sender of the event.
 */
