...
/**
 Base class for all Wielgosz_Michael_Project3_LocalStorage views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Wielgosz_Michael_Project3_LocalStorage view hierarchy (such as wrapped iOS UIViews) was touched.
