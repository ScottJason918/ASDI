...
//Rare exceptions to indicate a bug in the _wielgosz_michael_project3_localstorage code (Eg, function that a subclass should have implemented)
...
/**
 The base class for Wielgosz_Michael_Project3_LocalStorage proxies.
 */
