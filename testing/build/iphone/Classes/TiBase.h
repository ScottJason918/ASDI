...
// in simulator we redefine to format for Wielgosz_Michael_Project3_LocalStorage Developer console
...
{\
	NSString * exceptionName = [@"org.wielgosz_michael_project3_localstorage." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.wielgosz_michael_project3_localstorage";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIWielgosz_Michael_Project3_LocalStorageNativeItemNone = -1, 
	UIWielgosz_Michael_Project3_LocalStorageNativeItemSpinner = -2,
	UIWielgosz_Michael_Project3_LocalStorageNativeItemProgressBar = -3,
	
	UIWielgosz_Michael_Project3_LocalStorageNativeItemSlider = -4,
	UIWielgosz_Michael_Project3_LocalStorageNativeItemSwitch = -5,
	UIWielgosz_Michael_Project3_LocalStorageNativeItemMultiButton = -6,
	UIWielgosz_Michael_Project3_LocalStorageNativeItemSegmented = -7,
	
	UIWielgosz_Michael_Project3_LocalStorageNativeItemTextView = -8,
	UIWielgosz_Michael_Project3_LocalStorageNativeItemTextField = -9,
	UIWielgosz_Michael_Project3_LocalStorageNativeItemSearchBar = -10,
	
	UIWielgosz_Michael_Project3_LocalStorageNativeItemPicker = -11,
	UIWielgosz_Michael_Project3_LocalStorageNativeItemDatePicker = -12,
	
	UIWielgosz_Michael_Project3_LocalStorageNativeItemInfoLight = -13,
	UIWielgosz_Michael_Project3_LocalStorageNativeItemInfoDark = -14,
	
	UIWielgosz_Michael_Project3_LocalStorageNativeItemDisclosure = -15,
	
	UIWielgosz_Michael_Project3_LocalStorageNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Wielgosz_Michael_Project3_LocalStorage instances of
