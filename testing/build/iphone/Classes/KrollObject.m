...
//@interface Wielgosz_Michael_Project3_LocalStorageObject : NSObject
//@end

@interface Wielgosz_Michael_Project3_LocalStorageObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Wielgosz_Michael_Project3_LocalStorageObject class]])
		{
			for (NSString *key in [[(Wielgosz_Michael_Project3_LocalStorageObject*)o modules] allKeys])
			{
