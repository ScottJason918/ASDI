 ...
 * to send analytic data that can be viewed on the Wielgosz_Michael_Project3_LocalStorage Dashboard.
 *
 * For information on getting started with Wielgosz_Michael_Project3_LocalStorage Platform Services,
