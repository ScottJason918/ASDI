...
@interface Wielgosz_Michael_Project3_LocalStorageObject : KrollCoverageObject {
#else
@interface Wielgosz_Michael_Project3_LocalStorageObject : KrollObject {
#endif
@private
...
extern NSString * Wielgosz_Michael_Project3_LocalStorage$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Wielgosz_Michael_Project3_LocalStorageObject *_wielgosz_michael_project3_localstorage;
    KrollObject* console;
	BOOL shutdown;
